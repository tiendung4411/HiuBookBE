...
public class SummarySubjectService {
    ...
    public Optional<SummarySubject> getSummarySubjectById(String summarySubjectId) {
    ...
    public List<SummarySubject> getSummarySubjectsBySummaryId(String summaryId) {
        ...
        if (summaryOptional.isPresent()) {
            ...
            return summarySubjectRepository.findBySummary(summary); // Sử dụng findBySummary
        } else {
